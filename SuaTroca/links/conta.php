    ...
    <div class="container">
        ...
        <div class="row">
          <div  class="col-md-6 col-md-offset-3">
            <form class="form" role="form" action="../function/login.php" method="POST" class="col-md-4 col-offset-4">
              ...
              <a href="cadastrar_user.php"><button type="submit" class="btn btn-default">Cadastro</button></a>
          </div>
        </div>
        <!-- Footer -->
        <footer align="center">
